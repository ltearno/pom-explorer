...
public class ExportCommand
{
	...
	public void csv( Client client, ApplicationSession session, Log log )
	{
...
class ExportVisitor
{
	...
	public ExportVisitor( ApplicationSession session ) throws FileNotFoundException, UnsupportedEncodingException
	{
